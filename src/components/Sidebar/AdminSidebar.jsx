  ...
  return (
    ...
    >
      ...
      <nav className="mt-16 space-y-4 px-4">
        ...
        <Link to="/studentregister" className="block py-2 hover:bg-blue-700 rounded transition-colors duration-200">
          Student Registration 
        </Link>
        <Link to="/facultyregister" className="block py-2 hover:bg-blue-700 rounded transition-colors duration-200">
          Faculty Registration
        </Link>
        <Link to="/studentmanagement" className="block py-2 hover:bg-blue-700 rounded transition-colors duration-200">
          Student Management 
        </Link>
